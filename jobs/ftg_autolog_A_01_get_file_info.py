...
if __name__ == "__main__":
    ...
    try:
        ...
        # Update status based on false start detection
        if is_false_start:
            field_data[FIELD_MAPPING["status"]] = "False Start"
            print(f"  -> Setting status to: False Start")
        else:
            field_data[FIELD_MAPPING["status"]] = "1 - Imported"
            print(f"  -> Setting status to: 1 - Imported")
