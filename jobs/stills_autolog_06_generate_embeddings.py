...
if __name__ == "__main__":
    ...
    try:
        ...
        # Execute the PSOS script for generating embeddings
        psos_script = "STILLS - AutoLog - 06B - Generate Embeddings (PSOS)"
        ...
        if script_error == '0':
            print(f"SUCCESS [generate_embeddings]: {stills_id}")
            sys.exit(0)
        else:
        ...
        sys.stderr.write(f"Error [generate_embeddings] on {stills_id}: {e}\n")
        sys.exit(1) 