#!/usr/bin/env python3
"""
LF AutoLog Poller - Step 1: Get File Info

Independent polling loop for extracting basic file information from video files.
Polls every 10 seconds for fast response to new imports.
"""
...
STEP_CONFIG = {
    ...
    "timeout": 300,
    "max_workers": 8,
    "poll_interval": 10  # Fast response for new imports
}
...
def main():
    ...
    try:
        ...
        while True:
            ...
            if records:
                tprint(f"🔍 Found {len(records)} LF records")
