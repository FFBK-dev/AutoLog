...
SERVER   = os.getenv("FILEMAKER_SERVER",  "YOUR_FILEMAKER_SERVER_IP")
DB_NAME  = "Your Database Name"
USERNAME = os.getenv("FILEMAKER_USERNAME", "your_username")
PASSWORD = os.getenv("FILEMAKER_PASSWORD", "your_password")
# ───────────────────────────────────────────────────────────────────────────
...
VOLUMES = {
    "stills": "Your Stills Volume",
    "footage": "Your Footage Volume"
}
# ───────────────────────────────────────────────────────────────────────────
...
def ensure_volume_mounted(file_path):
    ...
    if "/Volumes/Your Stills Volume/" in file_path:
        return mount_volume("stills")
    elif "/Volumes/Your Footage Volume/" in file_path:
