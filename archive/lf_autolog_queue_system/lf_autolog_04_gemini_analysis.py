...
{{
  ...
  "global": {{
    ...
    "synopsis": "2-4 sentence factual description. Start directly with subject/action. NO phrases like 'This video shows' or 'The footage depicts'. Include date at end.",
    "date": "YYYY/MM/DD or YYYY/MM or YYYY format, empty string if unknown",
    "location": "City, ST format with 2-letter state codes ONLY if clearly identifiable (e.g. 'Chicago, IL', 'New York, NY'). Empty string if unclear.",
